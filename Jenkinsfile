    ...
    stages {
        stage('Create  directory for the WEB Application')        
       {
            steps {
                ...
                sh 'rm -rf /Users/orlando/jenkins/app-web'
                //Create the directory
                sh 'mkdir /Users/orlando/jenkins/app-web'               
            }
        }
        ...
        stage('Create the containers in Parallel') {
            parallel{
                ...
                {           
                    ...
                    sh 'docker run -dit --name app-web-apache -p 9100:80  -v /Users/orlando/jenkins/app-web:/usr/local/apache2/htdocs/ httpd'
                    }
                }
        ...
        stage('Copy the web application to the container directory') {
            steps {
                ...
                sh 'cp -r web/* /Users/orlando/jenkins/app-web'
            }
        }
    }
